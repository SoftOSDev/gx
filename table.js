...
//以数组的形式储存
var people=new Array("Q2K_", "aaa111", "NoCodeRockStar","FILLYLIN_light","Undefined（）","syx1233456");
var money=new Array("15R", "9R", "10","0","0","60");
var changes=new Array("无", "无", "无","无","无","无");
var reason=new Array("开服,维护", "使用绿宝石兑换", "设计世界纪录村交所","此前因考试暂未上线","因学业未上线","修建大量红石机器；研发；赞助500");
